        ...
        >
            ...
            <div class="row-fluid">
                <div class="form-group span12">
                    ...
                    <input class="form-control" maxlength="128" name="<?php echo $this->modulo['modulo']; ?>[pai]" value="<?php if(isset($this->cadastro)){echo $this->cadastro['pai'];} ?>" required>
                </div>
            </div>
            <div class="row-fluid">
                <div class="form-group span12">
                    <label>Nome da Mãe</label>
                    <input class="form-control" maxlength="128" name="<?php echo $this->modulo['modulo']; ?>[mae]" value="<?php if(isset($this->cadastro)){echo $this->cadastro['mae'];} ?>" required>
                </div>
            </div>
            ...
            <div class="row-fluid">
                ...
                <div class="form-group span7">
                    ...
                    <input class="form-control" maxlength="128" name="<?php echo $this->modulo['modulo']; ?>[patologia]" value="<?php if(isset($this->cadastro)){echo $this->cadastro['patologia'];} ?>" required>
                </div>
            </div>
